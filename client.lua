...
CreateThread(function()
    ...
    exports.ox_target:addModel(Config.BMXITEM, {
        {
            icon = "fas fa-bicycle",
            label = "Prendre le bmx",
            onSelect = function()
...
print("BMX Item By Seiko | Fly Dev's and Leaks") -- Si vous retiré le print merci de ne pas vous approprier le script